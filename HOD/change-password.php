...
{
$sql=mysqli_query($con,"SELECT hod_pass FROM  hod where hod_pass='".md5($_POST['password'])."' && id_num='".$_SESSION['alogin']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"update hod set hod_pass='".md5($_POST['newpassword'])."', updationDate='$currentTime' where id_num='".$_SESSION['alogin']."'");
