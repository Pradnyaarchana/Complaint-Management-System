...
<!-- <select name="department" class="span8 tip" required>
	<option value="<?php echo htmlentities($row['hodDept']);?>"><?php echo htmlentities($hodDept=$row['hodDept']);?></option>
	...
	<input type="text"  name="department" value="<?php echo  htmlentities($hodDept=$row['hodDept']);?>" class="span8 tip" disabled>
</div>
</div>
