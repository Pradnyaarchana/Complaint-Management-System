...
<head>
	...
	<title>AGR | Principal login</title>
...
<body style="background-image:url('images/bgimg.jpg');">
	<div class="container">
		<br>
  	<a href="">
			<h2 style="color: white">AGR | Principal</h2>
	</a>
		</a></li>
				...
				<div class="module module-login span4 offset4">
					<form class="form-vertical" method="post">
						<div class="module-head"style="background-color: #005b81">
							<center ><h2 style="color: #fff">PRINCIPAL LOGIN</h2></center>
						</div>
						...
						<div class="module-foot" style="background-color: #005b81">
							<div class="control-group">
								<div class="controls clearfix">
									<center>
									<button type="submit" class="btn btn-primaryy btn-md"   name="submit" >Login</button>
									</center>
								</div>
							</div>
						</div>
	...
	<div class="footer">
		<div class="container">
			 ...
			 <br>
			 <br>
			<b class="copyright">&copy; 2023 AGR </b> All rights reserved.
		</div>
	</div>
