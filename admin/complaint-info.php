...
<?php $st='closed';
$query=mysqli_query($con,"select complaints.*,user.fullName as name from complaints join user on user.id=complaints.userId  where complaints.complaintNumber='".$_GET['cid']."' and complaints.category='Admin' ");
