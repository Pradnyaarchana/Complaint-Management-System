...
<html lang="en">
  <head>
    ...
    <title>AGR | Complaint Details</title>
...
<label class="col-sm-2 col-sm-2 control-label"><b>HOD :</b> </label>
              <div class="col-sm-4">
              <p><?php echo htmlentities($row['hod']);?></p>
              </div>
            </div>
...
<!-- "select * from complaints where userId='".$_SESSION['id']."' and complaintNumber='".$_GET['cid']."'"

"select complaintremark.remark as remark,complaintremark.status as status,complaintremark.remarkDate as rdate from complaintremark join tblcomplaints on complaints.complaintNumber=complaintremark.complaintNumber where complaintremark.complaintNumber='".$_GET['cid']."'" -->

<?php 
$ret=mysqli_query($con,"select * from complaintremark where  complaintNumber='".$_GET['cid']."'");
