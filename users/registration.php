...
if(isset($_POST['submit']))
{
	...
	$status=1;
	$query=mysqli_query($con,"insert into user(fullName,userEmail,password,contactNo,status) values('$fullname','$email','$password','$contactno','$status')");
...
<html lang="en">
  <head>
    ...
    <title>AGR | User Registration</title>
...
error:function (){}
  ...
  <body style="background-image:url('userimages/bgimg.jpg');
  background-repeat: no-repeat;
	background-attachment: fixed;
	background-size: 100% 100%;">
	  <div id="login-page">
	  	<div class="container" style="margin-bottom:50px;">
	<h3 align="center" style="color:#fff">Anonymous Grievance Redressal</h3>
	<hr />
