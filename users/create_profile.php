...
//id  fullName  userEmail password  contactNo address gender  dob category  prn_no  department  userImage regDate updationDate  status
...
<html lang="en">
  <head>
    ...
    <title>CMS | User Create Profile</title>
...
<SCRIPT>  
 ...
 <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
  ...
  <h4 class="mb"><i class="fa fa-user"></i>&nbsp;&nbsp; Registration Form</h4>
...
<div class="form-group">
  ...
  <label class="col-sm-2 col-sm-2 control-label">DOB</label>
    <div class="col-sm-4">
        <i class="fa fa-calendar fa-lg"></i>&nbsp&nbsp&nbsp&nbsp<input type="text" name="dob" id="date_ex">
    </div>
</div>
...
<div class="col-sm-4">
<input type="text" name="regdate" required="required" class="form-control" readonly>
 </div>

 <label class="col-sm-2 col-sm-2 control-label">Password </label>
<div class="col-sm-4">
<input type="password" name="password" required="required" class="form-control" readonly>
 </div>
</div>
...
<a href="update-image.php">Set Photo</a>
